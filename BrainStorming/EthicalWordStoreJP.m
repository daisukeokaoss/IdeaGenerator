...
+(NSMutableArray *)GenerateWordArray
{
    ...
    NSArray *Socializm = @[@"資本主義",@"私有財産制",@"社会主義",@"生産手段の公有化",@"計画経済",@"空想的社会主義",@"オーウェン",@"ニューラナーク紡績工場",@"ニューハーモニー村",@"サン＝シモン",@"フーリエ",
    ...
    [EthicalWordStore addObjectsFromArray:Socializm];
    NSArray *JituzonSyugi = @[@"実存主義",@"人間疎外",@"無神論的実存主義",@"実存哲学",@"実存",@"キルケゴール",@"大地震",@"画一化",@"平均化",@"水平化",@"主体性",@"自己とは、自分自身にかかわる一つの関係である",
    ...
    [EthicalWordStore addObjectsFromArray:JituzonSyugi];
    NSArray *Puragumatism = @[@"フロンティア精神",@"プラグマティズム",@"実用主義",@"プラグマ",@"パース",@"いかに我々の観念を明晰にするか",@"プラグマティズムの格率",@"形而上学クラブ",@"ジェームズ",@"真理の有用性",
    ...
    [EthicalWordStore addObjectsFromArray:Puragumatism];
    NSArray *seimeirinnri = @[@"生命科学",@"生命工学",@"バイオテクノロジー",@"DNA",@"デオキシリボ核酸",@"ワトソン",@"クリック",@"ヒトゲノムの解読",@"ゲノム",@"遺伝子情報",@"ヒトゲノム",@"遺伝子組み換え",
        ...
        @"ホスピス＝ケア",@"ビハーラ"];
    [EthicalWordStore addObjectsFromArray:seimeirinnri];
    NSArray *Kannkyou = @[@"公害",@"公害対策基本法",@"環境基本法",@"大気汚染",@"水質汚濁",@"海洋汚染",@"水俣病",@"苦海浄土",@"石牟礼道子",@"土壌汚染",@"科学技術",@"テクノロジー",@"環境問題",
    ...
    [EthicalWordStore addObjectsFromArray:Kannkyou];
    NSArray *Kazoku = @[@"イエの制度",@"基礎集団",@"第一次集団",@"機能集団",@"家父長制",@"パターナリズム",@"拡大家族",@"複合家族",@"大家族",@"直系家族",@"核家族",@"マードック",@"核家族化",@"小家族化",
    ...
    [EthicalWordStore addObjectsFromArray:Kazoku];
    NSArray *Jyouhou = @[@"管理社会",@"官僚制",@"ビューロクラシー",@"テクノクラート",@"情報化",@"情報社会",@"高度情報社会",@"脱工業化社会",@"マス＝メディア",@"情報メディア",@"疑似環境",@"マス＝コミ",
    ...
    [EthicalWordStore addObjectsFromArray:Jyouhou];
    NSArray *Kokusai = @[@"国際社会",@"国際連合",@"国連",@"市場経済",@"ボーダレス",@"国際化",@"グローバリゼーション",@"グローバル社会",@"グローバリズム",@"反グローバリゼーション",@"外国人労働者",
