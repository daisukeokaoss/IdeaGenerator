...
-(NSMutableArray *)GenerateWordArray
{
    ...
    NSArray *EWord1 = @[@"心にくい",@"熱を上げる",@"見下す",@"反論",@"均等",@"ありきたり",@"強制的",@"頭ごなし",
                        ...
                        @"思い上がる",@"足を引っ張る",@"見過ごす"];
    [ElementaryWordStore addObjectsFromArray:EWord1];
    NSArray *EWord2 = @[@"面持ち",@"地団駄を踏む",@"寛大",@"拒否",@"証",@"丸め込む",@"まんべんなく",@"内弁慶",
                        ...
                        @"先決",@"ふれこみ",@"うろ覚え"];
    [ElementaryWordStore addObjectsFromArray:EWord2];
    NSArray *EWord3 = @[@"自滅",@"お膳立て",@"耳をそろえて",@"高をくくる",@"貫禄",@"群がる",@"もってこい",
    ...
    [ElementaryWordStore addObjectsFromArray:EWord3];
    NSArray *EWord5 = @[@"念入り",@"ざわめく",@"往々にして",@"かきいれどき",@"後ずさり",@"ポイント",@"一日の長",
                        ...
                        @"炊く",@"煮る"];
    [ElementaryWordStore addObjectsFromArray:EWord5];
    NSArray *EWord6 = @[@"ためしがない",@"万全",@"ぼう然",@"切り札",@"謙遜",@"無理強い",@"目と鼻の先",
                        ...
                        @"頭に血がのぼる",@"遅かれ早かれ",@"気落ち"];
    [ElementaryWordStore addObjectsFromArray:EWord6];
    NSArray *EWord7 = @[@"ぶざま",@"かならずしも",@"まんざら",@"無断",@"悔やむ",@"本音",@"顔が青くなる",
    ...
    [ElementaryWordStore addObjectsFromArray:EWord7];
    //以下、中学入試完成レベル
    NSArray *EWord8 = @[@"束縛",@"侮辱",@"惰性",@"意固地",@"もくろみ",@"第一印象",@"さんぜんと",@"恒例",@"すえた",
                        ...
                        @"天真爛漫",@"等身大",@"願い下げ"];
    [ElementaryWordStore addObjectsFromArray:EWord8];
    NSArray *EWord9 = @[@"殺伐",@"血迷う",@"徴用",@"理詰め",@"時ならぬ",@"世知辛い",@"殺風景",@"憶測",@"草分け",
                        ...
                        @"口はばったい",@"つつがなく",@"徘徊"];
    [ElementaryWordStore addObjectsFromArray:EWord9];
    NSArray *EWordA = @[@"起因",@"盾に取る",@"口さがない",@"極上",@"二枚目",@"肯定",@"たたき上げ",@"独擅場",
    ...
    [ElementaryWordStore addObjectsFromArray:EWordA];
    NSArray *EWordB = @[@"回想",@"推移",@"配慮",@"模索",@"バリアフリー",@"余韻",@"質素",@"信条",@"脳裏",@"悪びれた",
                        ...
                        @"正論"];
    [ElementaryWordStore addObjectsFromArray:EWordB];
    NSArray *EWordC = @[@"生む",@"産む",@"測る",@"量る",@"解く",@"説く",@"カルテット",@"クラシック",@"コンサート",
                        ...
                        @"冥利"];
    [ElementaryWordStore addObjectsFromArray:EWordC];
    NSArray *EWordD= @[@"ジリ貧",@"東奔西走",@"型破り",@"否応なく",@"先がない",@"執着",@"棒に振る",@"陰湿",@"甘美",
                       ...
                       @"さびれる",@"因習",@"機構",@"混沌",@"落成",@"隔離"];
    [ElementaryWordStore addObjectsFromArray:EWordD];
    NSArray *EWordE= @[@"唯一無二",@"戒律",@"弊害",@"中枢",@"ドロップアウト",@"福音",@"交易",@"パイオニア",
                       ...
                       @"暴落",@"伐採",@"頭角を現す",@"フェミニスト"];
    [ElementaryWordStore addObjectsFromArray:EWordE];
    NSArray *EWordF = @[@"腹を探る",@"満面の笑み",@"騒然",@"手綱を締める",@"本望",@"パーソナルコンピュータ",@"ノックアウト",
    ...
    [ElementaryWordStore addObjectsFromArray:EWordF];
    NSArray *EWordG = @[@"おぞましい",@"紅一点",@"仲むつまじい",@"あっけらかん",@"往来",@"どこ吹く風",@"慣れる",@"馴れる",
    ...
    [ElementaryWordStore addObjectsFromArray:EWordG];
    return ElementaryWordStore;
}
