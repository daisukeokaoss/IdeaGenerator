...
+(NSMutableArray *)GenerateWordArray
{
    ...
    NSArray *kaWord = @[@"課",@"科",@"カーキ色制服",@"土色",@"KGB",@"ガーター勲章",@"過圧",@"加圧式排気機構",@"加圧水型原子炉",
        ...
        @"艦船搭載放射能探知測定機",@"艦船の当直",@"感染病",@"観戦武官",@"完全武装",@"隊員懲罰",@"完全武装懲罰行軍",
        @"完全武装歩兵",@"完全分解修理",@"完全編成師団",@"完全防護服",@"艦船用慣性航法装置",@"艦船用反応装甲",
        @"幹線路",@"閑送",@"通信文",@"閑送電報",@"換装",@"歓送迎会",@"乾燥重量",@"緩速",@"緩速回転",@"観測位置",
        @"観測員",@"緩速運転",@"観測及び目標捕捉",@"観測機",@"観測気球",@"観測者",@"観測射撃",@"観測所",
        @"観測値",@"観測不能",@"艦隊",@"艦隊混成飛行隊",@"艦隊指揮センター",@"艦隊司令長官",@"艦隊前進停泊所",
        @"艦隊即応飛行隊",@"艦隊付海兵隊",@"艦隊付航空団",@"艦隊偵察飛行隊",@"艦隊乗組み海兵隊員",@"艦隊錨泊地",
        @"艦隊兵站支援隊",@"艦隊防空",@"艦隊/飛行配置",@"艦隊衛星通信",@"艦隊海兵隊",@"艦対艦決戦",@"艦対艦ミサイル",
        @"艦対艦誘導弾",@"寒帯気候",@"艦対空ミサイル",@"艦対空誘導弾",@"艦対空誘導弾護衛駆逐艦",@"艦対空誘導兵器",
        @"艦隊航空気象衛星",@"艦隊航空機整備隊",@"艦隊航空偵察飛行隊",@"艦隊航空分遣隊",@"艦隊航空優越訓練",@"艦隊情報戦センター",
        @"艦隊情報センター",@"艦隊司令",@"艦隊司令官艦橋",@"艦対潜水艦ミサイル",@"艦隊通信士官",@"艦隊付軍医",
        @"艦隊付砲術士官",@"艦体番号",@"環太平洋",@"環太平洋空軍参謀長等会議",@"環太平洋合同演習",@"環太平洋諸国海軍合同演習",
        @"艦隊を閉じ込め動けなくする",@"感知起爆信管付子弾",@"感知起爆信管付弾薬",@"艦長",@"艦長室",@"間諜",
        @"官庁間協力",@"官庁間調整",@"艦長訓戒",@"艦長候補者課程",@"干潮水面",@"干潮面",@"艦長予定者",@"貫通",
        @"貫通して",@"艦艇が陸地に乗り上げる",@"艦艇艤装員",@"艦艇就役年数延長計画",@"艦艇修理員",@"艦底衝撃",
        @"艦艇搭載砲",@"艦底の膨らみ",@"艦底の湾曲部",@"艦底湾曲部構造",@"監的勤務員",@"観的壕",@"監的手",@"監的倉庫",
        @"貫徹",@"貫徹量",@"貫徹力",@"貫徹させる",@"貫徹深度",@"貫徹する",@"乾電池",@"感度",@"感度校正",@"感度調整",
        @"感度調定",@"感動",@"関東軍",@"敢闘精神",@"監督",@"監督下の単独飛行",@"監督官",@"感度どうか?送れ",
        @"無線用語",@"感度良好",@"無線通信",@"無線用語",@"艦内営倉",@"艦内拡声器",@"艦内拡声器装置",@"艦内警務隊",
        @"艦内食堂",@"艦内炊事所",@"艦内戦闘情報所",@"艦内通信",@"艦内通路",@"艦内通話装置",@"艦内病室",@"カンニング",
        @"緩燃剤",@"感応機雷",@"感応掃海",@"感応薬",@"殉爆試験",@"感応領域",@"艦の艤装",@"寒波",@"完爆",@"頑張る",
        @"頑張れ",@"甲板",@"甲板員",@"艦の安全航行を任す",@"甲板士官",@"甲板積載",@"甲板積み貨物",@"甲板部",
        @"潜水艦搭載",@"甲板砲",@"乾パン",@"甲板清掃棒雑巾",@"甲板長",@"艦尾",@"艦尾接近攻撃法",@"官費",
        @"艦尾の方向へ",@"艦尾方向",@"官品",@"幹部",@"幹部食堂",@"幹部候補生",@"幹部候補生学校",@"幹部候補生学校教育期間",@"幹部上級課程",@"幹部初級課程",@"幹部達",@"幹部特修課程",@"幹部評議会",@"幹部要員",@"乾餅",
        @"観兵式",@"岸壁",@"鑑別",@"官報",@"艦砲射撃",@"艦砲射撃士官",@"艦砲射撃統制班",@"艦砲連絡士官",@"灌木",@"潅木除去機",@"カンボジア地雷除去及び被災者救助局",@"カンボジア地雷除去活動センター",
        @"ガンマ線",@"ガンマ線放射",@"ガンマニア",@"簡明",@"感明どうか?",@"感明ともに良し",@"感明ともに良し!",@"ガンメタル",@"観目線",@"含薬",@"導火線等の製造",@"関与",@"官用航空機空荷待ち郵便輸送",
        @"官用車",@"感良し",@"感弱し",@"管理",@"管理地域",@"管理部",@"管理部長",@"管理補給隊",@"管理移動",@"管理及び兵站通信網",@"管理換え",@"管理監査",@"管理計画",@"管理検査",@"管理航空機",@"管理行進",
        @"管理支援",@"管理指揮",@"管理指揮系統",@"管理事項",@"管理者",@"管理上陸",@"管理指令",@"管理地図",@"管理通信網",@"管理搭載",@"管理統制",@"監理部長",@"管理編成",@"管理命令",@"簡略形式",
        @"官僚的形式主義",@"完了日",@"慣例",@"慣例計器飛行",@"寒冷前線",@"寒冷地試験センター",@"寒冷地用糧食",@"関連液気圧式駐退復座装置",@"関連質問",@"関連書類",@"関連する",@"関連任務",@"関連部隊",
        @"感悪し"];
    [MilitaryWordStoreJp addObjectsFromArray:kaWord];
    NSArray *KiWord = @[@"期",@"疑-",@"気圧計",@"気圧高度",@"気圧式平衡機",@"気圧の谷",@"起案",@"起案者",@"キー",@"キール",@"船",@"黄色シャッの走行誘導員",@"黄色の手持ち式信号板",@"旗衛隊",@"消え伏せろ!",
        @"起縁",@"起縁円筒型",@"起縁部",@"起縁部厚",@"起縁部経",@"起縁薬莢",@"気温の逆転",@"機械",@"機械化",@"機械加工",@"機械化する",@"機械化部隊",@"機械化砲兵観測車",@"機械化歩兵",@"機械化歩兵師団",
        @"機械化歩兵大隊",@"機会均等",@"機械言語",@"機械式時限信管",@"機械式信管",@"機外大気温度",@"機械的噛み合わせ",@"機械的故障",@"機械的妨害",@"機械的磨耗",@"機外搭載",@"機械の故障",@"議会の国庫支出金承認",
        @"議会名誉勲章銀",@"危害予防",@"着替え",@"気化器",@"気化器の凍結",@"企画",@"企画・運用",@"企画担当士官",@"企画班",@"規格",@"規格貨物",@"規格統一",@"規格外れ許可",@"規格変更通知",@"機関",
        @"帰還",@"技官",@"機関員",@"機関拳銃",@"機関号令",@"機関室",@"機関室当直士官",@"機関銃",@"機関銃架",@"4連装機関銃",@"機関銃座",@"機関銃手",@"機関銃陣地の巣",@"機関銃陣地",@"機関銃巣",
        @"機関銃托架",@"機関使用終了",@"機関長",@"機関停止!",@"期間表示",@"機関部",@"帰還不能限界点",@"帰還不能点",@"機関砲",@"機関用意",@"機関号令",@"基幹要員",@"帰還予定時刻",@"危機管理",@"危機管理能力",
        @"機器雑音",@"危機対応部隊",@"危機対処班",@"聞き取れる",@"利き目",@"気球",@"気球観測",@"気球反射器",@"器具",@"器具灯",@"菊水",@"特攻作戦名",@"菊のご紋章",@"奇計",@"危険",@"死亡する危険あり",
        @"危険性の高い任務",@"危険物輸送に関する勧告",@"危険を冒す",@"危険界",@"危険貨物",@"危険区域",@"危険区分",@"危険工室",@"危険水域",@"危険性破片",@"危険性を取り除く",@"期限超過",@"期限付技術指令",
        @"期限付き技術指令処理要領",@"危険手当",@"期限統制",@"危険特別手当",@"危険度分類試験",@"危険な命令",@"危険に陥れる",@"危険にさらす",@"危険に身をさらす",@"危険の検定率",@"危険半径",@"危険標識",
        @"危険物",@"危険物資",@"危険を伴わない軍事飛行任務",@"危険を取り除く",@"寄港",@"寄港地",@"機甲",@"機甲師団",@"機甲戦闘",@"機甲部隊",@"記号",@"機甲科将校初級課程",@"機甲騎兵連隊",@"偽工事",
        @"気候順応",@"機甲偵察連隊",@"聞こえますか?",@"聞こえる",@"技師",@"疑似",@"疑似雑音符号",@"疑似信号",@"疑似ランダム雑音",@"騎士階級の勲位・勲章",@"疑似回路",@"儀式",@"疑似空中線",@"疑似弾頭",
        @"疑似遅延線路",@"騎士道",@"疑似負荷",@"疑似目標",@"記者会見",@"基尺",@"旗手",@"機首",@"機首上げ",@"機首上げ傾向",@"機首曳航",@"機首下げ",@"機首装備銃",@"機首装備砲",@"機首搭載機関銃",@"機首搭載機関砲",
        @"機首引上げ",@"奇襲",@"奇襲攻撃",@"騎銃",@"機銃安全解除スイッチ",@"起重機",@"奇襲作戦",@"機銃照準装置の赤い点",@"機銃掃射",@"奇襲隊員",@"奇襲大隊",@"奇襲部隊",@"機銃用レーダー目標照準点",
        @"機首下部ポッド",@"機種選定飛行",@"技術",@"技術委員会",@"技術移転",@"技術運営委員会",@"技術援助",@"技術援助契約",@"技術開発",@"技術開発型",@"技術教範",@"技術教範及びカタログ等",@"技術協力",
        @"技術訓練",@"技術系統",@"技術契約",@"技術研究本部",@"技術検査",@"技術検査記録用紙",@"技術高級課程",@"陸上自衛隊",@"技術広報",@"技術顧問",@"技術再投資計画",@"技術査定局",@"記述されている",
        @"技術支援各科",@"技術支援部隊",@"技術試験",@"技術試験供試車",@"技術指示",@"技術実証計画",@"技術将校",@"技術仕様書",@"技術情報",@"技術情報資料",@"技術情報班",@"技術資料",@"技術指令",@"技術指令実施要領",
        @"技術指令書",@"技術指令処理要領",@"技術図面",@"記述する",@"技術・製造開発段階",@"技術提案",@"技術提携",@"技術データ",@"技術データ・パッケジ",@"技術的奇襲",@"技術統制",@"技術統制班",@"技術統制分析センター",
        @"技術特技",@"技術特性",@"技術突破",@"技術の",@"技術兵",@"技術変更解析",@"技術変更提案",@"技術変更要求",@"技術変更要求/承認",@"技術報告書",@"技術要求事項",@"技術練度",@"機首の引き起こし",@"機首方位",
        @"機首を左右に振る",@"規準",@"基準",@"基準艦",@"基準献立表",@"基準信号",@"基準針路",@"基準線",@"基線",@"射撃",@"計器等の基準位置",@"基準弾",@"基準点",@"基準迫撃砲",@"基準標桿",@"基準砲",
        @"基準ロット",@"記章",@"起床",@"徽章",@"機上",@"機上自己防御ジャマ",@"機上早期警戒装置",@"機上早期警戒レーダー",@"機上無線機",@"機上無線中継",@"機上命令",@"機上要撃装置",@"機上要撃用レーダー",
        @"機上レーザー目標指示装置",@"機上レーダー",@"機上レーダー局",@"機上レーダー射撃照準装置",@"機上移動目標指示器",@"気象衛星",@"机上演習",@"機上画像記録装置",@"機上監視・地上統制",@"機上監視・統制",
        @"気象観測",@"気象観測器材",@"機上観測員",@"気象観測用ロケット",@"気象記号",@"気象基準面",@"起床!起床!もたもたするな!",@"機上指揮センター",@"機上磁気探知機",@"機上磁気探知装置",@"機上指揮統制中枢",
        @"機上射撃",@"気象修正",@"気象修正係数",@"機上乗員訓練",@"気象諸元",@"機上整備",@"機上整備員",@"気象戦士",@"機上戦術士官",@"機上掃射",@"気象台",@"儀じょう隊",@"機上長距離警戒",@"機上通信員",
        @"機上電子幹部",@"機上熱映像レーザー指示機",@"気象の",@"偽情報",@"欺情報",@"欺情報作戦",@"機上目視目標標定システム",@"機上輸送係",@"機上要撃管制士官",@"機上要撃指令士官",@"気象予報官",@"起床ラッパ",
        @"機上レーザー",@"偽地雷",@"擬地雷原",@"議事録",@"偽信",@"擬人体",@"細菌兵器実験用",@"偽陣地",@"規整",@"規制",@"規制品目",@"規正",@"擬製",@"擬製魚雷",@"擬製信管",@"擬製地雷",@"擬製弾",
        @"規整子",@"偽製地雷",@"寄生振動",@"寄生振動防止装置",@"寄生虫",@"既製品目",@"規正補給品",@"擬製マスタード",@"寄生有害抗力",@"軌跡",@"既設砲座",@"基線長",@"起線部",@"基礎",@"偽装",@"偽装看破",
        @"偽装規律",@"偽装した戦車",@"偽装網",@"艤装",@"艤装委員",@"偽造身分証明証",@"規則",@"規則類",@"義足",@"規則にやかましい人",@"貴族や将校の社会的責務",@"基礎研究",@"基礎指導",@"基礎配置",@"機体",
        @"帰隊",@"帰隊時限ラッパ",@"議題",@"帰隊式典",@"帰隊時限24時迄の外出",@"帰隊時刻",@"機体重量",@"機体旋動式ミサイル",@"気体爆薬",@"鍛える",@"北大西洋軍",@"北大西洋条約機構",@"NATO基本軍事要求",
        @"NATO彼我識別装置",@"NATO統合通信システム",@"NATO整備・補給機関",@"NATO整備・補給機構",@"NATO海上哨戒航空機機構",@"NATOミサイル射撃施設",@"NATO海軍顧問団",@"NATO生産・兵站組織",@"NATO緊急対応機動部隊",
        @"NATO潜水艦演習",@"NATO潜水艦戦術群",@"NATO弾",@"NATO物品番号",@"NATO",@"NATO標準化協定",@"北朝鮮",@"北朝鮮人民軍",@"汚い爆弾",@"北ベトナム軍",@"擬弾着筒",@"基地",@"基地外",@"基地群",
        @"基地群共同防御",@"基地再配置",@"基地周辺防御",@"基地司令",@"基地整備",@"基地隊員食堂",@"基地通信組織",@"基地内",@"基地売店",@"基地兵站",@"基地補給",@"基地補給将校",@"基地防衛",@"基地防衛作戦",
        @"基地防衛作戦センター",@"基地防衛隊",@"基地防衛連絡班",@"基地防空",@"基地群作戦センター",@"基地群指揮官",@"基地憲兵隊長",@"基地航空隊",@"基地航空団",@"基地広報部",@"基地支援装備品",@"基地守備隊",
        @"基地司令官",@"基地調達事務所",@"基地等の公開日",@"既知の距離",@"基地泊",@"機長",@"議長",@"貴重品",@"きつい検査",@"偽追尾航法",@"偽通信文",@"気付き先",@"機付整備班",@"機付長",@"機付長方式",
        @"気付",@"気付先",@"喫水",@"喫水線",@"木槌",@"キット",@"規定",@"規定核貯蔵量",@"規定された",@"規定された条件",@"規定されている",@"規定される",@"規定する",@"偽底層",@"規定平均最大圧力",
        @"起点",@"基点",@"輝点",@"儀典",@"国と国のエチケット",@"儀典官",@"企図",@"輝度",@"輝度変調",@"帰投",@"帰投する",@"帰投誘導局",@"機動",@"機動演習",@"機動計画",@"機動作戦",@"機動性",
        @"機動大隊",@"機動打撃",@"機動打撃部隊",@"機動打撃部隊",@"機動に任ずる部隊",@"機動班",@"機動部隊",@"機動力",@"機動力と火力",@"起動圧",@"機動型個別誘導再突入体ミサイル",@"軌道からの離脱",
        @"機動間整備",@"機動艦隊",@"機動間野外整備",@"機動器材研究開発コマンド",@"機動橋",@"機動後方支援部隊",@"機動支援",@"機動式水中機雷",@"起動指示",@"軌道制御",@"機動性の良い",@"機動戦闘機",
        @"機動隊",@"機動値",@"MV値",@"機動統制組織",@"帰投に必要な最小限の燃料",@"機動防御",@"起動輪",@"軌道を回る",@"輝度調整",@"機内拡声装置",@"機内通話装置",@"記入",@"絹製薬のう",@"記念品",
        @"気のう",@"機能",@"機能検査",@"機能試験",@"機能図",@"機能不良",@"機能別訓練",@"機能本位",@"機能要素",@"機能異常",@"技能検定",@"技能向上再訓練",@"機能試験飛行",@"技能証明書",@"機能停止",
        @"機能点検飛行",@"機能不全",@"きのこ化現象",@"キノコ雲",@"核爆発による雲",@"起爆",@"起爆感度",@"起爆剤",@"起爆薬",@"起爆安全",@"起爆安全回路",@"起爆安全装置",@"起爆シーケンス",@"起爆信管",
        @"起爆する",@"起爆装置",@"起爆筒",@"希薄波",@"希薄波帯",@"起爆薬未使用雷管",@"起爆雷管",@"木箱",@"基板",@"基盤火力",@"厳しい訓練",@"厳しい現実",@"厳しい使用条件",@"機敏性",@"起伏地",
        @"起伏の多い地形",@"騎兵",@"騎兵刀",@"欺へん",@"偽へん行動",@"偽へん目的",@"欺騙",@"気泡雑音",@"希望する駐屯地",@"基砲線",@"希望選定部隊",@"規模縮小",@"基本運行重量",@"基本角",@"基本給",
        @"基本教育",@"基本訓練",@"基本計画",@"基本原則",@"基本攻撃目標リスト",@"基本構成要素",@"基本交付表品目",@"基本射場",@"小火器",@"基本射場での射撃",@"基本射場における射撃",@"基本周波数",
        @"基本水準面",@"基本水中爆破",@"基本水中爆破海軍特殊部隊",@"基本線",@"基本戦術編成",@"基本戦闘機動",@"基本戦闘訓練",@"基本操作",@"基本単位部隊",@"基本定数表",@"基本的考慮事項",
        @"基本に帰れ",@"基本部隊単位",@"基本編隊",@"決まりきった仕事",@"きまり文句",@"欺瞞",@"欺瞞手段",@"欺まん",@"欺瞞攻撃",@"欺まん行動",@"機密",@"機密書類取扱許可",@"機密取扱許可",
        @"気密",@"気密試験",@"気密性試験",@"機密区画化情報",@"機密区画化情報施設",@"気密室",@"気密帯",@"気密端子",@"機密保持法",@"義務感",@"キムジョンイル",@"金正日",@"義務・責任等を果たす",
        @"義務不履行",@"脚架組立",@"逆起電力",@"逆起爆",@"脚槓桿",@"逆合成開口レーダー",@"逆鉤てい",@"逆鉤外し",@"脚座",@"虐殺",@"逆止弁",@"逆襲",@"逆襲計画",@"逆上陸",@"逆浸透膜浄水装置",
        @"客席",@"虐待",@"逆探",@"逆宙返り",@"逆転層",@"逆転防止機構",@"逆噴射装置",@"逆包囲",@"逆方位角",@"逆流電流",@"逆流防止弁",@"却下",@"客観的証拠",@"逆鉤",@"逆鈎安全引抜き腕金",@"逆鈎安全ピン引抜き索",
        @"逆鈎作動桿",@"逆鈎作動桿止",@"逆鈎栓",@"逆鈎段部",@"逆鈎梃",@"逆鈎止部",@"逆鈎外し",@"逆鈎バネ",@"逆鈎バネピン",@"逆鈎板",@"逆鈎板止めピン",@"逆鈎ピン",@"逆鈎保持部",@"逆鈎レバー",
        @"逆鈎レバー軸ピン",@"キャニスター",@"キャパシタンス",@"キャビテーション",@"キャビテーション雑音",@"キャリブレータ",@"吸引",@"救援部隊",@"救援物資",@"急横転",@"休暇",@"休暇申請を出し許可された休暇",
        @"休暇で不在",@"休暇願い書",@"休暇外出",@"休暇許可証",@"急角度上昇",@"休暇証",@"急加速発進",@"旧患",@"吸気弁",@"救急車",@"救急処置",@"救急処置訓練",@"救急のう",@"救急箱",@"救急病室",
        @"救急品袋",];
    [MilitaryWordStoreJp addObjectsFromArray:KiWord];
