...
+(NSMutableArray *)GenerateWordArray
{
    ...
    NSArray *MeWord = @[@"メガドラ",@"メガドライバー",@"メガドライブ",@"メガドライブ2",@"メガドラ兄さん",@"めくり",@"メシア教",@"メッセージスキップ",@"メテオ",@"メテオ技",@"メトロイド",
        ...
        @"ロードに成功しました",@"ロードワーク50km",@"ロープレ",@"ロールちゃん",@"ロールプレイングゲーム",@"ローンチタイトル",@"ログインゲーム"];
    [WordStore addObjectsFromArray:MeWord];
